...
use App\Http\Controllers\Owner\TransaksiController as OwnerTransaksi;
use App\Http\Controllers\Owner\KendaraanController as OwnerKendaraan;
...
Route::middleware(['auth', 'role:owner'])
    ...
    ->group(function () {
        ...
        Route::get('/transaksi',        [OwnerTransaksi::class, 'index'])->name('transaksi.index');
        Route::get('/transaksi/print',  [OwnerTransaksi::class, 'print'])->name('transaksi.print');
        Route::get('/kendaraan',        [OwnerKendaraan::class, 'index'])->name('kendaraan.index');
        Route::get('/kendaraan/print',  [OwnerKendaraan::class, 'print'])->name('kendaraan.print');
    });
